        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://www.google.com/maps?q=Darcy+Aviation+Danbury+CT"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li className="flex items-start gap-2.5">
                ...
                <a href="https://maps.google.com/?q=1+Wallingford+Rd+Danbury+CT+06810" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors">
                  1 Wallingford Rd<br />Danbury, CT 06810
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:+12036170645" className="hover:text-gold transition-colors font-medium">(203) 617-0645</a>
              </li>
              <li className="flex items-center gap-2.5">
