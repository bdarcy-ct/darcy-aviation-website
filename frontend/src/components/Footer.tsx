      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-aviation-blue to-gold flex items-center justify-center font-bold text-navy-900 text-lg">
                DA
              </div>
              <span className="text-white font-bold text-lg">Darcy Aviation</span>
            </Link>
            <p className="text-slate-400 text-sm leading-relaxed">
              Premier flight training and aircraft maintenance at Danbury Municipal Airport (KDXR), Connecticut.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.to}>
                  <Link to={link.to} className="text-slate-400 hover:text-gold transition-colors text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Private Pilot', 'Instrument Rating', 'Commercial Pilot', 'Multi-Engine', 'Discovery Flights'].map((item) => (
                <li key={item}>
                  <Link to="/training" className="text-slate-400 hover:text-gold transition-colors text-sm">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              <li className="flex items-start gap-2">
                ...
                <span>1 Wallingford Rd<br />Danbury, CT 06810</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+12036170645" className="hover:text-gold transition-colors">(203) 617-0645</a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:admin@darcyaviation.com" className="hover:text-gold transition-colors">admin@darcyaviation.com</a>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} Darcy Aviation LLC. All rights reserved.
          </p>
