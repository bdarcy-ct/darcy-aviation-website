...
export default function PPL() {
  return (
    <TrainingDetailPage
      ...
      heroDescription="Your journey starts here. The Private Pilot License is your gateway to the skies — the foundation certificate that lets you fly single-engine aircraft, carry passengers, and explore the country from above."
      heroIcon={heroIcon}
      overview={[
